...
const {login, signUp, phoneVerification, resetPassword, recoverView, reciverNewPassword} = new AuthController()
authRouter.post('/login', login);
authRouter.post('/signup', signUp);
authRouter.post('/phone_verification', checkCode,phoneVerification)
